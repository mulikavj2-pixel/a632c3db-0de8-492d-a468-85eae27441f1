...
export const metadata: Metadata = {
  title: "Fresh Fund - Israeli Venture Capital & Startup Investing",
  description: "Fresh Fund invests in breakthrough Israeli startups across fintech, AI, and cybersecurity. Strategic capital and global networks from Tel Aviv.",
  keywords: "venture capital, Israeli startups, tech investment, Tel Aviv, fintech, AI, cybersecurity",
  metadataBase: new URL("https://freshfund.il"),
  alternates: {
    canonical: "https://freshfund.il"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Fresh Fund - Fueling Israeli Tech Innovation",
    description: "Invest in the next generation of Israeli technology leaders with Fresh Fund",
    siteName: "Fresh Fund",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765804389863-4cf3kaqk.jpg",
        alt: "Fresh Fund - Israeli Venture Capital"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Fresh Fund - Israeli Tech Investment",
    description: "Backing breakthrough startups from Tel Aviv to the world",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765804389863-4cf3kaqk.jpg"]
  }
};
